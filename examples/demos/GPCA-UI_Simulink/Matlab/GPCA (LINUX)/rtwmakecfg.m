...
%   MATLAB file generated on : 27-Mar-2015 17:48:22
...
% Dependency info for S-function 'websocket_serverLCT'
info(1).SFunctionName = 'websocket_serverLCT';
info(1).SourceFiles = {'websocket_server.c'};
info(1).HostLibFiles = {'libwebsockets.so'};
info(1).Language = 'C';
