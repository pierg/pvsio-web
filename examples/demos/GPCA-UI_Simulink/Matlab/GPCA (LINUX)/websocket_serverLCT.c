 ...
 *
 *        int32 y1 = WebsocketServer(uint32 u1, uint32 u2, double u3, double u4, int32 y2[1], double y3[1], double y4[1])
 *
 *   Simulink version           : 7.9 (R2012a) 29-Dec-2011
 *   C source code generated on : 27-Mar-2015 17:48:20
...
/*
   ...
   def.OutputFcnSpec = 'int32 y1 = WebsocketServer(uint32 u1, uint32 u2, double u3, double u4, int32 y2[1], double y3[1], double y4[1])';
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
   ...
   */
  *y1 = WebsocketServer( *u1, *u2, *u3, *u4, y2, y3, y4);
}
